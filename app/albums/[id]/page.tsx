      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex rounded overflow-hidden">
            <Link href={`/albums/${album.id}/edit`} className="bg-yellow-500 w-10 h-10 flex items-center justify-center">✏️</Link>
            <button onClick={deleteAlbum} className="bg-red-600 w-10 h-10 flex items-center justify-center">🗑️</button>
          </div>
        </div>
        
        {album.coverPath && <img src={album.coverPath} alt={album.title} className="w-48 h-48 object-cover rounded mx-auto mb-4" />}
